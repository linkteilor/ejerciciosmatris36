 ...
 */
public class Ejerciciosmatriz36 {
...
public static void main(String[] args) {
        ...
        switch(nombreAlgoritmo){
            ...
            case "5":{ imprimirMtriz(pregunta5()); }break;            
            case "6":{ imprimirMtriz(pregunta6()); }break;            
            case "7":{ imprimirMtriz(pregunta7()); }break;            
            case "8":{ imprimirMtriz(pregunta8()); }break;            
            case "9":{ imprimirMtriz(pregunta9()); }break;            
            case "13":{ imprimirMtriz(pregunta13()); }break;            
            case "15":{ imprimirMtriz(pregunta15()); }break;            
            case "16":{ imprimirMtriz(pregunta16()); }break;            
            case "20":{ imprimirMtriz(pregunta20()); }break;            
            case "21":{ imprimirMtriz(pregunta21()); }break;            
            case "24":{ imprimirMtriz(pregunta24()); }break;            
            case "25":{ imprimirMtriz(pregunta25()); }break;            
            case "30":{ imprimirMtriz(pregunta30()); }break;            
            case "31":{ imprimirMtriz(pregunta31()); }break;            
            case "32":{ imprimirMtriz(pregunta32()); }break;            
            case "33":{ imprimirMtriz(pregunta33()); }break;            
            case "34":{ imprimirMtriz(pregunta34()); }break;            
            case "35":{ imprimirMtriz(pregunta35()); }break;            
            case "36":{ imprimirMtriz(pregunta36()); }break;            
    ...
    int numInit=lt.nextInt();//dim=5 numInit=0
        for(int c=0;c<dim/2;c++){
            for (int ld = dim-1; ld < dim-1-c; ld++) {
              M[dim-1-c][ld]=numInit;
              numInit++;
            }
            for (int li = dim-1-c; li >c; li--) {
